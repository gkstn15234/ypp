# 🌟 HugoDiscoverPro - 오토데일리 자동차 경제 미디어 플랫폼

## 📋 프로젝트 개요

**오토데일리**는 Hugo 정적 사이트 생성기를 기반으로 구축된 현대적인 자동차 경제 전문 미디어 플랫폼입니다. 자동차 산업과 경제에 특화된 전문 콘텐츠 관리 솔루션을 제공합니다.

### 🎯 핵심 목표
- **시의성 있는 자동차 경제 정보**: 빠르고 신뢰도 높은 자동차 경제 정보 전달
...
```bash
# 새 기사 생성
hugo new automotive/new-article.md
hugo new economy/business-news.md
...
categories: ["자동차"]
tags: ["자동차", "경제", "모빌리티"]
# 구글 디스커버 최적화: 최소 1200px 이상, 권장 1600px 이상
images: ["https://example.com/image-1600x900.jpg"]
author: "오은진"
ai_generated: false
trend_score: 85
word_count: 1200
...
### 구글 디스커버 이미지 가이드라인
- **최소 크기**: 1200px 이상 (권장: 1600px)
- **종횡비**: 16:9 권장
- **품질**: 고화질 (95% 이상)
- **형식**: JPG, PNG, WebP
- **가이드**: [구글 디스커버 이미지 가이드](docs/GOOGLE_DISCOVER_IMAGE_GUIDE.md) 참고
...
> **오토데일리**는 데이터 분석과 전문성을 결합하여 차세대 자동차 경제 미디어의 새로운 기준을 제시합니다.
