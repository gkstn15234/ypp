# 🌟 HugoDiscoverPro - 이콘밍글 경제뉴스 플랫폼

## 📋 프로젝트 개요

**이콘밍글**은 Hugo 정적 사이트 생성기를 기반으로 구축된 현대적인 경제 전문 뉴스 미디어 플랫폼입니다. AI 기반 자동 뉴스 생성 시스템과 함께 완전히 자동화된 컨텐츠 관리 솔루션을 제공합니다.

### 🎯 핵심 목표
- **시의성 있는 경제 뉴스**: 빠르고 신뢰도 높은 경제 정보 전달
...
```bash
# 새 기사 생성
hugo new economy/new-article.md
hugo new it/tech-news.md
...
> **이콘밍글**은 AI 기술과 전문 저널리즘을 결합하여 차세대 경제 뉴스 미디어의 새로운 기준을 제시합니다.
